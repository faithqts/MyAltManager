...
-- This table is intentionally defined only up to level 10, the maximum reward tier.
-- Logic in GetWeeklyDungeonRewards caps higher keystone levels (11+) to use the level 10 entry.
